...
$name = "LA CREME DE LA CREME";
$message = "Place the HTML changes within the <body> tag of your HTML file and the CSS changes within the <style> tag in the <head> section of your HTML file. These adjustments will reposition the buttons according to your specifications. Adjustments to margins, paddings, or other styles can be made according to your design requirements.";
