...
$name = "Lara CROFT";
$message = "You can apply a fade-in animation to the book details when the page loads. This effect gradually reveals the content and creates a smooth transition.
