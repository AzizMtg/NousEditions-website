...
$message = "This way, if the 'Roboto' font fails to load, the fallback font (specified as sans-serif) will be displayed in an italic style. Adjust the font-weight, font-size, or any other font-related properties as needed to match your preferred design for the book detail page.
