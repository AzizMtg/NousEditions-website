...
$message = "If the typing animation still doesn't display, please check if the $message variable contains the expected content and if there are any JavaScript errors in the browser console that might be affecting the execution of the script.
...
<body>
    ...
    <script>
        ...
        // Trigger typing animation when the page content is loaded
