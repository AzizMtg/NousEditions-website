...
$name = "INVINCIBLE";
$message = "Ensure that you've replaced the section displaying the book description in your HTML file with the provided code snippet. Adjust the animation speed (speed variable) or other styles as needed for your specific design.
...
<body>
    ...
    <script>
        ...
        // Clear existing content before starting typing animation
