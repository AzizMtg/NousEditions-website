    ...
    <script>
        ...
        function typeWriter() {
            if (i < descriptionText.length) {
                document.getElementById("book-description").innerHTML += descriptionText.charAt(i);
                i++;
