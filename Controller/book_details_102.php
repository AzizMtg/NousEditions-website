...
$name = "tessssst";
$message = "Feel free to explore other Google Fonts or web fonts from different providers to find a font that best suits your design preferences for the book detail page. Simply replace 'Roboto' with the name of the font you'd like to use, and update the link to import that specific font's styles from the appropriate source. Adjust the weight, style, or other attributes based on your design needs.
...
<head>
    <style>
        body {
            font-family: 'Roboto', sans-serif; /* 'Roboto' font with a fallback to sans-serif */
            margin: 0;
            padding: 0;
