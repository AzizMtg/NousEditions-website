...
$name = "Siwar Chayada";
$message = "Nous vous remercions sincèrement d'avoir soumis votre manuscrit à notre maison d'édition. Après une analyse minutieuse, nous devons malheureusement décliner sa publication pour l'instant. Votre travail est apprécié, cependant, en raison de contraintes éditoriales actuelles, nous ne sommes pas en mesure de donner suite à cette publication. Nous vous encourageons néanmoins à explorer d'autres maisons d'édition pour donner vie à votre œuvre littéraire. Nous vous souhaitons plein succès dans vos démarches futures et vous remercions à nouveau pour votre intérêt envers notre maison d'édition";
//$etat = "non traitee"; // Include the fetched etat_contribution
$id="180";
$email="siwar.chayada@esprit.tn";
