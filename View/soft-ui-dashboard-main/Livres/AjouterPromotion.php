...
if (		
    ...
    {   
        ...
        header("Location:AfficherPromotion.php?successMessage= Promotion ajouté avec succés");
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../Livres/AfficherLivres.html">
            ...
            <span class="nav-link-text ms-1">Afficher</span>
          </a>
        </li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <center><h1>Nouveau Promotion</h1></center>
            </div>
            ...
            <div class=" input-group mb-3 ">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control"  name="tauxRemise" id="tauxRemise"  placeholder= "tauxRemise " min="1">
                </div>
            </div>
...
<<<<<<< Updated upstream
            ...
            <label class="col-sm-3 col-form-label ">dateDebut</label>
                <div class="col-sm-6">
                    <input type="date" class="form-control" name="dateDebut" id="dateDebut"  placeholder= "dateDebut">
                </div>
            </div>
            <!---------------------------------------------dateFin---------------------------------------------->
            <div class="input-group mb-3">
...
>>>>>>> Stashed changes
            <!---------------------------------------------Buttons---------------------------------------------->
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherPromotion.php" description="button">Retour</a>
             </div>
          </div>
        </form>
              </div>
