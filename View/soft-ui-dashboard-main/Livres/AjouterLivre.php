...
if (		
    ...
    {   
        ...
        $LivreC->AjouterLivres($livre);
        header("Location:AfficherLivres.php?successMessage= Livre ajouté avec succés");
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../Livres/AfficherLivres.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class=" input-group mb-3 ">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control"  name="nom" id="nom"  placeholder= "Nom Livre">
                </div>
            </div>
            ...
            <div class="input-group mb-3">
                    <label class="col-sm-3 col-form-label ">Stock</label>
                      <div class="col-sm-6">
                    <input type="number" class="form-control" name="stock" id="stock"  placeholder ="Stock"  min="1">
                </div>
            </div>
            <!---------------------------------------------description---------------------------------------------->
            <div class="input-group mb-3">
          ...
          <!---------------------------------------------Taux Remise---------------------------------------------->
          <div class="input-group mb-3">
                    <label class="col-sm-3 col-form-label ">Taux Remise</label>
                      <div class="col-sm-6">
                    <select  class="form-control" name="tauxRemise" id="tauxRemise">
                        <?php
                ...
                $listePromotions = $LivreC->Afficherpromotion();
                foreach($listePromotions as $promotion){ 
                    ?>
                    <option value="<?php echo $promotion['idP']; ?>" class="form-control" ><?php echo $promotion['tauxRemise']; ?></option>    
                    <?php
                    //fin foreach 
                    }
                    ?>
            ...
            <!---------------------------------------------Buttons---------------------------------------------->
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherLivres.php" description="button">Retour</a>
             </div>
          </div>
        </form>
              </div>
