...
include_once '../../../Controller/Siwar/promotionC.php';
    ...
    if (		
        ...
        if (			
            ...
            header('Location:AfficherPromotion.php?mess= promotion Modifé avec succés');
      ...
      <div class="row">
		...
		?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="tauxRemise" id="tauxRemise" value="<?php echo $promotion['tauxRemise'];?>">
                </div>
            </div>
            <!---------------------------------------------dateDebut---------------------------------------------->
            <div class="row mb-3">
            <label class="col-sm-3 col-form-label "  >dateDebut</label>
                <div class="col-sm-6">
                    <input type="date" class="form-control" name="dateDebut" id="dateDebut" value="<?php echo $promotion['dateDebut']; ?>">
                </div>
            </div>
            <!---------------------------------------------dateFin---------------------------------------------->
            <div class="row mb-3">
            <label class="col-sm-3 col-form-label "  >dateFin</label>
                <div class="col-sm-6">
                    <input type="date" class="form-control" name="dateFin" id="dateFin" value="<?php echo $promotion['dateFin']; ?>">
                </div>
            </div>
             <!---------------------------------------------Buttons---------------------------------------------->
             <div class="row mb-5">
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherPromotion.php" role="button">Retour</a>
             </div>
          </div>
            </table>
        </form>
