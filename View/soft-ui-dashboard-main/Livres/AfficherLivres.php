...
<style>
    /* Ajuster la largeur et la position de la barre de recherche DataTables */
/* Personnaliser la barre de recherche DataTables */
.dataTables_wrapper .dataTables_filter input {
  width: 400px; /* Ajustez la largeur souhaitée de la barre de recherche */
  padding: 10px; /* Ajustez le rembourrage pour un look agréable */
  border: 2px solid #808080; /* Augmentez l'épaisseur de la bordure */
  border-radius: 20px; /* Ajoutez des coins plus arrondis */
  background-color: #d3d3d3; /* Définissez la couleur d'arrière-plan en gris clair */
  color: #000000; /* Définissez la couleur du texte en noir */
...
=======
  ...
  <script>
    function confirmDelete(idL) {
        var confirmDelete = confirm("Êtes-vous sûr de vouloir supprimer ce livre  ?");
        if (confirmDelete) {
            window.location.href = 'SupprimerLivre.php?idL=' + idL;
        }
    }
</script>
...
<<<<<<< Updated upstream
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../Livres/AfficherLivres.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<<<<<<< Updated upstream
            <span class="nav-link-text ms-1">Afficher Livres</span>
=======
...
>>>>>>> Stashed changes
    ...
    <?php
           if(isset($_GET['successMessage'])){
            ...
            echo "<div class='alert alert-success alert-dismissible fade show' rol e='alert'>
            '$successMessage'
...
<<<<<<< Updated upstream
				<a class="btn btn-primary" href="AjouterLivre.php" role="button">Nouveau Livre</a>
        <a class="btn btn-primary" href="AfficherPromotion.php" role="button">Voir Promotions</a>
=======
				<a class="btn btn-primary-sm" href="AjouterLivre.php" role="button">Nouveau Livre</a>
        <a class="btn btn-primary-" href="AfficherPromotion.php" role="button">Voir Promotions</a>
>>>>>>> Stashed changes
        <a class="btn btn-primary" href="AfficherLivres.php?tr=y" role="button">Tri Nom</a>
...
<<<<<<< Updated upstream
      ...
      <?php
			...
			?>
                  <tr>
				<td><?php echo $livre['idL']; ?></td>
				<td><?php echo $livre['nom']; ?></td>
				<!--<td><?php echo $livre['auteur']; ?></td>-->
        <td><?php echo $livre['prix']; ?> tnd</td>
				<td><img style="max-width: 30%;max-height=30%" src="./image/<?php echo $livre['couverture']; ?>"></td>
...
<<<<<<< Updated upstream
				...
				<td>
					<a  class="btn btn-danger btn-sm"   href="Supprimerlivre.php?idL=<?php echo $livre['idL']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
...
=======
        ...
        <td>
        <a href="javascript:void(0);" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo $livre['idL']; ?>)">supprimer</a>
        </td>
