...
include_once '../../../Controller/Siwar/LivresC.php';
    ...
    if (		
        ...
        if (move_uploaded_file($tempname, $folder)) {
            ...
            $LivreC->ModifierLivres($livres,$_GET["idL"]);
            header('Location:AfficherLivres.php?mess= Livre Modifé avec succés');
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <center><h1>Nouveau Livre</h1></center>
            </div>
            <?php
			if (isset($_GET['idL'])){
				$livres = $LivreC->RecupererLivres($_GET['idL']);
		...
		?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="nom" id="nom" value="<?php echo $livres['nom'];?>">
                </div>
            </div>
            <!---------------------------------------------auteur---------------------------------------------->
            <div class="row mb-3">
            <label class="col-sm-3 col-form-label "  >auteur</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="auteur" id="auteur" value="<?php echo $livres['auteur']; ?>">
                </div>
            </div>
            <!---------------------------------------------prix---------------------------------------------->
            <div class="row mb-3">
            <label class="col-sm-3 col-form-label "  >Prix</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="prix" id="prix" value="<?php echo $livres['prix']; ?>">
                </div>
            </div>
            ...
            <!---------------------------------------------couverture---------------------------------------------->
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label " >couverture</label>
                      <div class="col-sm-6">
                    <input type="file" class="form-control" name="couverture"  id="couverture" value="<?php echo $livres['couverture']; ?>">
                      </div>
                </div>
            <!---------------------------------------------stock---------------------------------------------->
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="stock" id="stock" value="<?php echo $livres['stock']   ; ?>">
                </div>
             </div>
            <!---------------------------------------------description---------------------------------------------->
                <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="description" id="description" value="<?php echo $livres['description']; ?>">
                </div>
             </div>
                      <!---------------------------------------------tauxRemise---------------------------------------------->               
                            <div class="input-group mb-3">
            <label class="col-sm-3 col-form-label">tauxRemise</label>
            <div class="col-sm-6">
        <select id="idP" name="tauxRemise" class="form-control">
            <?php
            ...
            $listesPromotions = $LivreC->Afficherpromotion();
            foreach ($listesPromotions as $promotion) {
                $idP = $promotion['idP'];
            ?>
                <option value="<?php echo $promotion['idP']; ?>" <?php if ($idP && $promotion['idP'] == $idP) echo "selected"; ?>><?php echo $promotion['tauxRemise']; ?></option>
            <?php
            }
            ?>
        </select>
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherLivres.php" role="button">Retour</a>
             </div>
          </div>
            </table>
        </form>
