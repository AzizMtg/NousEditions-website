                ...
                <form id="form" action="" method="POST">
                      ...
                      <input  class="titre modifier_input" type="text" value="Reclamation pour le client N : <?= $reclamation['id']; ?>" readonly>
                         ...
                         <div class="divgrid">
                             ...
                             <input  class="modifier_input" type="text" name="nom" value="<?php echo $reclamation['nom']; ?>" readonly>
                         </div>
                         <div class="divgrid">
                            <label  class="r">Prenom du client </label>
                            <input class="modifier_input" type="text" name="prenom" value="<?php echo $reclamation['prenom']; ?>" readonly>
                        </div>

                   <div class="divgrid" >
                           <label class="r">Email du client</label>
                           <input class="modifier_input" type="text" name="email" value="<?php echo $reclamation['email']; ?>" readonly>
                       </div>
                       <div class="divgrid"  >
                          <label  class="r">Subject du Reclamation</label>
                          <input class="modifier_input" type="text" name="suijet" value="<?php echo $reclamation['sujet']; ?>" readonly>
                      </div>
 
                   
                       <div class="divgrid" >
                           <label class="r">Message du Reclamation</label>
                           <?php echo $reclamation['message']; ?>
                           <input type="hidden" name="reclamation" value="<?= $reclamation['message']; ?>">
                       </div>

                       <div class="divgrid" id="div1"  >
                           <label for="repense" class="r">Votre Repense</label>
