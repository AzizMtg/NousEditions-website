...
/*---------------------- voiir et rep reclamation imta3 il client  ---------------------------*/
...
if (isset($_POST["id"])&& isset($_POST["repense"]) ) {
    if (!empty($_POST["id"]) && !empty($_POST["repense"])) {
        $reclamationU = new reclamation( $reclamation["idReclamation"],$reclamation["iduser"],new DateTime($reclamation["date_envoie"])  , $reclamation["sujet"],$reclamation["message"] );
       ...
       $reponse = new reponse(null,$reclamation["idReclamation"],$_POST['repense'] , new DateTime($curentDate_r) ); 
...
<body class="g-sidenav-show  bg-gray-100 ">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="pages/statistic.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg table tazyin" >
    <!-- Navbar -->
    ...
    <section >
        ...
        <div class="reclamation-box">
            ...
            <a href="reclamation.php" ><img class="fleche" src="chaimaV2/images/retourne_fleche.png"></a>
                ...
                <form id="form" action="" method="POST">
                      ...
                      <input  class="titre modifier_input text" type="text" value="Reclamation pour le client  : " readonly>
                         ...
                         <div class="divgrid">
                             <label  class="r">Non du client</label>
                             <input  class="modifier_input" type="text"  value="<?php echo $client['firstName']; ?>" readonly>
                         </div>
                         <div class="divgrid">
                            <label  class="r">Prenom du client </label>
                            <input class="modifier_input" type="text"  value="<?php echo $client['lastName']; ?>" readonly>
                        </div>

                   <div class="divgrid" >
                           <label class="r">Email du client</label>
                           <input class="modifier_input" type="text" value="<?php echo $client['email']; ?>" readonly>
                       </div>
                       <div class="divgrid"  >
                          <label  class="r">Subject du Reclamation</label>
                          <input class="modifier_input" type="text"  value="<?php echo $reclamation['sujet']; ?>" readonly>
                      </div>
                      ...
                      <input type="submit" id="submit" class="but" value="repondre" onclick="return confirm('Mit2akid it7ib itfasa5 il reponse ?')">
